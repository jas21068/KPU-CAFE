...
val8 = val1 + val2 + val3 + val4
       val9 = val5 + val6 + val7
        val10 = val8 + val9
        print(val10)
        finallyyy.text = "You totall bill is $"+String(val10) + " + taxes"
        reciept.text = "A copy of the reciept has been  sent"
        email.text = "to your e-mail address."
    }
